...
printStep "Installing binaries ..."
 # utils
sudo apt-get -qq update;sudo apt-get install -qq -y software-properties-common dpkg make dnsutils locales curl git zsh vim xclip openssl tmux ca-certificates ssh rsync net-tools zip ncdu psmisc rsyslog
# btop
