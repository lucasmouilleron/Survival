...
brew update;brew install git glances tmux micro ncdu # utils
brew cask install contexts # contexts
brew cask install hammerspoon # hammerspoon
brew install saulpw/vd/visidata # visidata
